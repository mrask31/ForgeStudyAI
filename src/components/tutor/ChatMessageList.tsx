          ...
          return (
            <div key={m.id} className="flex justify-end">
              <div className="ml-auto max-w-[70%]">
                <div className="inline-block rounded-2xl bg-indigo-600 px-4 sm:px-5 py-3 text-sm font-medium text-white shadow-lg hover:shadow-xl transition-all duration-200 leading-relaxed break-words max-w-full">
                  {m.content}
                </div>
              </div>
            </div>
